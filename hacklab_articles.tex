...
only if passed by not less than two-thirds of those voting on the resolution
at an AGM or EGM (or if passed by way of a written resolution by not less than
two-thirds of members under clause \ref{clause:writtenresolution}):}
...
\clause{\label{clause:writtenresolution}A resolution agreed to in writing by a
  ...
  \subclause{To distinguish a written resolution from proposals that are not
  intended as resolutions, a written resolution must be clearly identified as
  such using the words "written resolution" and submitted to the board.}
  \subclause{A written resolution is passed by a majority if it is passed by
  members representing more than half of the total voting rights of members;
  with the exception of} \subclause{the types of resolution listed in clause
  \ref{clause:supermajority} which will be passed by members representing not
  less than two-thirds of the total voting rights of members.}
